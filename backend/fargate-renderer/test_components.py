...
This script tests the entire animation engine without rendering Manim videos.
It validates schemas, dispatchers, and registries.
"""
...
def main():
    ...
    print("█" * 60)
    print("█" + " " * 58 + "█")
    print("█" + "  CODE ANIMATOR - COMPONENT TEST SUITE".center(58) + "█")
    print("█" + " " * 58 + "█")
    print("█" * 60)
    print("\n")
    ...
    print("\nNext step: Render an animation with:")
    print("  python main.py storyboards/example_simple.json\n")
